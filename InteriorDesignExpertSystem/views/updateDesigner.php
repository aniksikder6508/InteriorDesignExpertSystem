 ...
 ?>
  <?php
                  ...
                  if ( isset($_POST['update']) ){
                    ...
                    $query = "UPDATE designer SET salary ='$Money'  WHERE designer_id = '$designer_id'";
                    ...
                    ?>
                      ...
                      <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                          <label for="id">Money</label>
                          <input type="text" class="form-control" id="id" aria-describedby="emailHelp" name="Money">
                        </div>
                        
                        
                        <input type="submit" class="btn btn-primary" value="Pay"  name="update">
